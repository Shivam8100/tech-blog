  ...
  const notableProjects = [
    {
      ...
      description:
        "Built a comprehensive blogging platform with interactive features, serving 25k+ monthly users",
    ...
    },
    {
      ...
      description:
        "Created real-time analytics dashboard for developer productivity metrics",
    ...
    },
    {
      ...
      description:
        "Developed and maintained a React component library used by 100+ companies",
    ...
    },
    {
      ...
      description:
        "Led migration from monolith to microservices architecture for e-commerce platform",
  ...
  const achievements = [
    {
      ...
      description: "Awarded by Antino Labs private Limited",
      year: "2023",
      icon: "Trophy",
    },
    {
      ...
      description:
        "Recognized for significant contributions to the React ecosystem",
      year: "2023",
      icon: "Star",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-text-secondary max-w-3xl mx-auto">
            Professional certifications, notable projects, and recognition that
