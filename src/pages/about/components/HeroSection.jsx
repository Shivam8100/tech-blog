          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-text-secondary leading-relaxed">
                I'm a passionate technologist dedicated to making complex concepts accessible, 
                fostering continuous learning, and building bridges between cutting-edge innovation 
            ...
            <div className="grid grid-cols-3 gap-6">
              ...
              <div className="text-center">
                ...
                <div className="text-sm text-text-secondary font-medium">Articles Written</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-success">25k+</div>
                <div className="text-sm text-text-secondary font-medium">Readers Helped</div>
              </div>
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="btn-primary px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 hover-lift">
                <Icon name="MessageCircle" size={20} />
                <span>Let's Connect</span>
              </button>
              <button className="btn-secondary px-6 py-3 rounded-lg font-semibold flex items-center justify-center space-x-2 hover-lift">
